            ...
            <div className="gets--home">
                ...
                <div className="right--align">
                    <div className="gets--content">
                        <img src="logo.png" alt="logo" width="300px" className="logo"></img>
                        <p className="gets--p">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Commodi nihil expedita voluptate in perferendis culpa </p>
